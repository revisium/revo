...
describe('external PostgreSQL owned client lifecycle', () => {
  ...
  it('requires verified TLS by default and permits an explicit plaintext connection', async () => {
  ...
  it('settles early cancellation and connection failure with safe bounded errors', async () => {
  ...
  it('cannot publish ready after timeout, close, or transport failure during accepted writes', async () => {
    const result =
